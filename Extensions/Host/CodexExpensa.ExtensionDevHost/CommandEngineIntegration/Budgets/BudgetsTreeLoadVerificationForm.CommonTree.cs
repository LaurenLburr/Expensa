...
public sealed class BudgetsTreeLoadVerificationFormCommonTree : Form
{
    private readonly CommonBudgetTreeContributionLoader loader = new();
    ...
    public BudgetsTreeLoadVerificationFormCommonTree()
    {
        Text = "Budgets Tree Load Verification - CommonTree";
        Width = 1000;
        Height = 650;
    ...
    private async Task LoadBudgetsTreeAsync()
    {
        ...
        statusLabel.Text = "Loading Budgets tree through CommonTree...";
        ...
        try
        {
            ...
            statusLabel.Text =
                $"Loaded {rootNodeCount} root node(s) through CommonTree.";
        }
        catch (Exception exception)
        {
            ...
            MessageBox.Show(
                this,
                exception.Message,
                "Budgets CommonTree Load Verification",
