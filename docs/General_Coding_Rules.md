...
- Use the modern Visual Studio Extensibility SDK only.
...
- Word wrap should be enabled where appropriate for documentation editing.
...
- UI layers should remain thin.
- Core logic should remain headless when possible.
