...
public partial class TreeTestTemplate : Form
{
    ...
    {
        InitializeComponent();
        SafeDataGridViewBinding.Attach(gridData);
    ...
    protected void SetGridData(
        object? dataSource)
    {
        gridData.DataSource = SafeDataGridViewBinding.Sanitize(dataSource);
    }
        ...
        DataTable table)
    {
        ...
        gridData.DataSource = SafeDataGridViewBinding.Sanitize(table);
    }
