...
public sealed class AccountDetailsForm : TaggedDetailsFormBase
{
            ...
            })
    {
        ...
        TagsGroup.Top = 395;
        TagsGroup.Width = 860;
        TagsGroup.Height = 275;
        TagsGroup.Anchor = AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right;
        ...
        details.Controls.Add(TagsGroup);

        RootPanel.Resize += (_, _) => LayoutForm();
        _tabDetails.Resize += (_, _) => LayoutDetails();

        _transactionsPanel = new AccountTransactionsPanel(_txns, _payees, _repo);
        _transactionsPanel.Dock = DockStyle.Fill;
    ...
    private void LayoutForm()
    {
        ...
        _tabs.Width = RootPanel.Width - 24;
        _tabs.Height = SaveButton.Top - _tabs.Top - 10;
    }

    private void LayoutDetails()
    {
        _groupBank.Width = _tabDetails.ClientSize.Width - 24;
        TagsGroup.Width = _tabDetails.ClientSize.Width - 24;
    ...
    public void LoadAccount(Account account)
    {
        ...
        UpdateCredentialLinkText();
        LoadTagsForEntity(account.AccountId);
