...
public sealed class RepositoryWorkflowRuntimeOperations : IWorkflowRuntimeOperations
{
    ...
    public IReadOnlyList<WorkflowRuntimeSummary> ListIncomplete()
    {
        return _repository
            ...
            .Select(workflow =>
            {
                ...
                {
                    return MapResumeState(resumeState);
                }
    ...
    private static WorkflowRuntimeOperationStatus MapOperationStatus(
        string status,
        bool isResumable)
    {
